...
const RandomItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	? `<div class="modal fade show" tabindex="-1" style="display: block;"><div class="modal-dialog"><div class="modal-content"><div class="modal-header modal-background"><button type="button" class="btn-close"></button></div> <div class="modal-body modal-body">${$recipies.length > 0
		? `${validate_component(ModalRecipie, "ModalRecipie").$$render($$result, { recipie: $recipies[$currentRecipieIndex] }, {}, {})}`
		: `<p data-svelte-h="svelte-qdsr2u">Loading...</p>`}</div> <div class="modal-footer modal-background"><button class="btn btn-secondary" data-svelte-h="svelte-1x3tjkl">Close</button> <button class="btn btn-primary" data-svelte-h="svelte-bipclg">Roll Again <img src="/Eatsy/images/dice.png" alt="dice" class="detail-icon"></button></div></div></div></div> <div class="modal-backdrop fade show svelte-ck9dnq"></div>`
	: ``}`;
});
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "main": ($$result2) => renderTemplate`${maybeRenderHead()}<div class="container-fluid mt-5 home-background"> <div class="row align-items-center"> <div class="col-md-6"> <img${addAttribute(imageUrl, "src")} class="img-fluid custom-rounded" alt="Descriptive Alt Text"> </div> <div class="col-md-6"> <div class="jumbotron p-5 custom-rounded"> <h1 class="display-4">Welcome to Eatsy</h1> <p class="lead text-center">Food for Thought</p> <hr class="my-4"> <p class="detail-info">
...
</p> ${renderComponent($$result2, "RandomItem", RandomItem, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Hazel/Documents/Project/Eatsy/src/components/RandomItem.svelte", "client:component-export": "default" })} </div> </div> </div> </div><div class="container mt-5 container-background"> <h3 class="display-4">Popular Recipes</h3> <div class="card-group row row-cols-1 row-cols-md-3 g-4"> ${recipies.recipes.map((recipie) => renderTemplate`<div class="col-md-4"> ${renderComponent($$result2, "RecipieCard", RecipieCard, { "recipie": recipie, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Hazel/Documents/Project/Eatsy/src/components/RecipieCard.svelte", "client:component-export": "default" })} </div>`)} </div> </div>` })}`;
